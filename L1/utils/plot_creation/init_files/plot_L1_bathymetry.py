...
def read_L1_bathy_and_wetgrid_from_grid(config_dir, model_name):
...
def create_bathymetry_plot(config_dir, L1_model_name, sNx, sNy, plot_tiles = True):

    depth, wet_grid = read_L1_bathy_and_wetgrid_from_grid(config_dir, L1_model_name)
