...
def plot_mitgrid_components(config_dir, print_level):
    ...
    import plot_L1_mitgrid_components as pm
    pm.create_mitgrid_plot(config_dir, L1_model_name, n_rows, n_cols)
...
if __name__ == '__main__':
    ...
    plot_mitgrid_components(config_dir, print_level=4)
