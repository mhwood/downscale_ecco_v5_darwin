...
def read_velocities_normal_to_boundary(config_dir, model_name,year,boundary,Nr,n_cols,n_rows,balanced):
    ...
    obcs_folder = os.path.join(config_dir,'L2', model_name,'input', 'obcs')

    if boundary=='east':

        uvel_east_file = os.path.join(obcs_folder,'annual','L2_BC_east_UVEL_'+str(year)+balanced_text)
    ...
    if boundary=='west':
        ...
        uvel_west_file = os.path.join(obcs_folder,'annual','L2_BC_west_UVEL_'+str(year)+balanced_text)
    ...
    if boundary == 'north':
        ...
        vvel_north_file = os.path.join(obcs_folder,'annual', 'L2_BC_north_VVEL_'+str(year)+balanced_text)
    ...
    if boundary == 'south':
        ...
        vvel_south_file = os.path.join(obcs_folder,'annual', 'L2_BC_south_VVEL_'+str(year)+balanced_text)
...
def balance_flux_on_boundaries(config_dir, boundaries, model_name, year, running_average_radius, Nr,n_cols,n_rows,
    ...
    if 'east' in boundaries:
        ...
        output_file = os.path.join(config_dir,'L2',model_name, 'input', 'obcs','annual', 'L2_BC_east_UVEL_'+str(year))
    ...
    if 'west' in boundaries:
        ...
        output_file = os.path.join(config_dir,'L2',model_name, 'input', 'obcs','annual', 'L2_BC_west_UVEL_'+str(year))
    ...
    if 'north' in boundaries:
        ...
        output_file = os.path.join(config_dir,'L2',model_name, 'input', 'obcs','annual', 'L2_BC_north_VVEL_'+str(year))
    ...
    if 'south' in boundaries:
        ...
        output_file = os.path.join(config_dir,'L2',model_name, 'input', 'obcs','annual', 'L2_BC_south_VVEL_'+str(year))
...
def balance_bc_fields(config_dir, model_name, boundaries, start_year, final_year, print_level):
    ...
    for year in range(start_year,final_year+1):
        ...
        # output_file = os.path.join(config_dir,'L2',model_name,'plots','init_files','BCs',model_name+'_unbalanced_fluxes_'+str(year)+'.png')
        ...
        # output_file = os.path.join(config_dir,'L2',model_name,'plots','analysis','flux_balances',model_name+'_balanced_fluxes_'+str(year)+'.png')
...
if __name__ == '__main__':
    ...
    balance_bc_fields(config_dir, L2_model_name, start_year, final_year, print_level=4)
