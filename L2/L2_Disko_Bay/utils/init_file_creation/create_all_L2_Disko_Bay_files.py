...
def create_L2_Disko_Bay_files(config_dir):
    ...
    parent_model_pickup_iteration = 52416
    ...
    if 6 in steps:
        ...
        cbc.create_BCs(config_dir, L2_model_name, parent_model_level, parent_model_name, print_level)
    ...
    if 7 in steps:
        ...
        cip.create_L2_iceplume_files(config_dir, mankoff_dir, print_level)
