...
def create_movies(config_dir, field_name, print_level):
    ...
    metadata_dict = {'EtaN': [0, 1, 'viridis', 'm', 'Surface Height Anomaly'],
                     ...
                     'Theta_AW': [10, 25, 'turbo', '$^{\circ}$C', 'Potential Temperature (257m)'],#
                    ...
                    'Chl01': [0, 1, 'turbo', 'mg/m$^3$', 'Diatom Functional Group'],
                    'Chl02': [0, 1, 'turbo', 'mg/m$^3$', 'Large Eukaryote Functional Group'],
                    'Chl03': [0, 1, 'turbo', 'mg/m$^3$', 'Synechococcus Functional Group'],
                    'Chl04': [0, 1, 'turbo', 'mg/m$^3$', 'Low-light adapted Prochlorococcus Functional Group'],
                    'Chl05': [0, 1, 'turbo', 'mg/m$^3$', 'High-light adapted Prochlorococcus Functional Group'],
                     'Total_Chl': [0, 1, 'turbo', 'mg/m$^3$', 'Total Chlorophyll'],
                     'SIarea': [0, 1, cm.ice, '', '']}
