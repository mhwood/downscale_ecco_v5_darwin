...
def create_L2_Upernavik_files(config_dir):
    ...
    glacier_IDs = np.arange(4,20).tolist()
    ...
    if 1 in steps:
        ...
        import create_L2_Upernavik_mitgrid as cm
    ...
    if 2 in steps:
        ...
        import create_L2_Upernavik_bathymetry as cb
    ...
    if np.any(np.array(steps)>2):
        ...
        if not os.path.exists(grid_path):
            sys.exit("Need to make the grid netcdf file for this model for reference\n"
                     "   - Run the stitch_L2_Upernavik_nc_grid_files_for_ref.py script with the -f 1 flag (and -r 150 -c 210)\n"
                     "   - Run the *for_grid model\n"
                     "   - Run the stitch_L2_Upernavik_nc_grid_files_for_ref.py script")

    # step 3: make the initial conditions
    if 3 in steps:
        print('Step 3: Creating the pickup (initial conditions) file for the ' + L2_model_name + ' model')
        import create_L2_Upernavik_pickup as cp
    ...
    if 4 in steps:
        ...
        import create_L2_Upernavik_seaice_pickup as cp
    ...
    if 5 in steps:
        ...
        import create_L2_Upernavik_exf as ce
    ...
    if 6 in steps:
        ...
        import create_L2_Upernavik_BCs as cbc
    ...
    if 7 in steps:
        ...
        import create_L2_Upernavik_iceplume as cip
        cip.create_L2_iceplume_files(config_dir, runoff_dir, termpicks_file, glacier_IDs,
    ...
    if 8 in steps:
        ...
        import create_L2_Upernavik_ptracer_pickup as cp
    ...
    if 9 in steps:
        ...
        import create_L2_Upernavik_darwin_pickup as cp
    ...
    if 10 in steps:
        ...
        import create_L2_Upernavik_dv_masks as cdv
        cdv.create_dv_masks(config_dir, L2_model_name, print_level)

    # step 11: make the iceberg files
    if 11 in steps:
        print('Step 11: Creating the iceberg files for the ' + L2_model_name + ' model')
        import create_L2_Upernavik_iceberg as cib
        cib.create_L2_iceberg_files(config_dir, L2_model_name, print_level)
...
if __name__ == '__main__':
    ...
    create_L2_Upernavik_files(config_dir)
